...
namespace MyDDDStore.WebApp.MVC.Controllers.Admin
{
    public class AdminProdutosController : Controller
    {
        ...
        {
            return View(await PopularCategorias(await _produtoAppService.FindByID(id)));
        }
        ...
        {
            return View("Estoque", await _produtoAppService.FindByID(id));
        }
        ...
        public async Task<IActionResult> AtualizarEstoque(Guid id, int quantidade)
        {
            ...
            return View("Index", await _produtoAppService.FindAll());
        }

        private async Task<ProdutoViewModel> PopularCategorias(ProdutoViewModel produto)
        {
            produto.Categorias = await _produtoAppService.FindCategories();
            return produto;
        }
    }
}