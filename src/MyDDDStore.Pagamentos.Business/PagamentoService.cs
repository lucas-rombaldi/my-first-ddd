...
namespace MyDDDStore.Pagamentos.Business
{
    public class PagamentoService : IPagamentoService
    {
        ...
        public async Task<Transacao> RealizarPagamentoPedido(PagamentoPedido pagamentoPedido)
        {
            ...
            {
                pagamento.AddEvent(new PedidoPagamentoRealizadoEvent(pedido.Id, pagamentoPedido.ClienteId, transacao.PagamentoId, transacao.Id, pedido.Valor));
            ...
            await _mediatorHandler.PublishEvent(new PedidoPagamentoRecusadoEvent(pedido.Id, pagamentoPedido.ClienteId, transacao.PagamentoId, transacao.Id, pedido.Valor));
